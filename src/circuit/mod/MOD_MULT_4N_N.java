 ...
 *  Y (the n-bit multiplier), M-1 (the n-bit modulus), -M (aka invM, 2^n-M).
 */
public class MOD_MULT_4N_N extends CompositeCircuit {
  ...
  protected void connectWires() {
    for (int i = 0; i < bitLength; i++) {
      inputWires[Y(bitLength - 1 - i)].connectTo(subCircuits[stepCircuit(i)].inputWires,
          MOD_SUB_MULT_4Nplus1_N.Y_i());
