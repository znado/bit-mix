 ...
 */
public class RUN_MULT extends Wrapper {
  public static boolean wasRun = false;

  protected void createSubCircuits() throws Exception {
    subCircuits[0] = new MOD_MULT_4N_N(AdditionCommon.BIT_LENGTH);
  ...
  protected void connectWires() {
    for (int i = 0; i < AdditionCommon.BIT_LENGTH; i++) {
      inputWire(Wrappers.X(i)).connectTo(subCircuits[0].inputWires, MOD_MULT_4N_N.X(i));
      inputWire(Wrappers.Y(i)).connectTo(subCircuits[0].inputWires, MOD_MULT_4N_N.Y(i));
    }
  }
